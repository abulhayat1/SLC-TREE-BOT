...
module.exports = class MeowCommand extends Command {
  ...
  "fields": [
    {
      "name": "Step :one: :",
      "value": "Tree link or Code , Type the code or paste the link for the room"
    },
    {
      "name": "Example:",
      "value": "`5D4GZW3` \** OR \** `https://forestapp.cc/join-room?token=5D4GZW3` \** OR \**  `Plant trees with me on Forest! Enter room code:5D4GZW3, or join by tapping here: https://forestapp.cc/join-room?token=5D4GZW3.`"
    },
    {
      "name": "Step :two: :",
    ...
    {
      "name": "Step :three: :",
      "value": " Tree starting in ,  In how many minutes will the tree be starting "
    },
    {
      "name": "Example:",
      "value": "type `6` or `10` :octagonal_sign: Dont Include `m` or `M` or `minutes`"
    },
    {
      "name": "Step :four: :",
    ...
    {
      "name": "Example:",
      "value": "`150` Or `55` or `60`  :octagonal_sign: Dont Include `m` or `M` or `minutes`"
    },
    {
      "name": "Step :five: :",
